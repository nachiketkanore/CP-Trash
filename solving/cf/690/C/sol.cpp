...
(ツ) All great men are gifted with intuition. They know without reasoning or analysis, what they need to know.
*/
#include <iostream>
#include <cstdio>
#include <cstdlib>
...
int SOD(int val) {
	return (val == 0 ? 0 : val % 10 + SOD(val / 10));
}
